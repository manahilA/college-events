...
if (isset($_POST['submit'])) { // Check press or not Post Comment Button
	...
	$sql = "INSERT INTO events (event_name, start_time, end_time, university, location, contact, privacy_level, event_description) VALUES ('$event_name', '$start_time', '$end_time', '$university', '$location', '$contact', 'private', '$event_description')";
