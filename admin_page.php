...
function listRSOEvents() {
   ...
   $result = mysqli_query($conn, " SELECT event_name, DATE(start_time) AS start_date, TIME(start_time) AS time_start, DATE(end_time) AS end_date, TIME(end_time) AS time_end, university, id FROM events WHERE privacy_level = 'rso event' AND rso = '$rsoid'");
...
<div class="container">
   ...
   <div class="content">
       ...
       <a href="host_rso_events.php?username=<?php echo $username?>" class="btn">Host RSO Event</a>
       <a href="host_private_events.php" class="btn">Host Private Event</a>
       <a href="host_public_events.php" class="btn">Host Public Event</a>
